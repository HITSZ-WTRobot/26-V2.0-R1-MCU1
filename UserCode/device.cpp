...
motors::DJIMotor *motor_drawer_1;
motors::DJIMotor *motor_drawer_2;
motors::DJIMotor *motor_drawer_3;
motors::DJIMotor *motor_drawer_4;
motors::DJIMotor *motor_wheel[4];
motors::DJIMotor *motor_drawer_out;
...
constexpr motors::DJIMotor::Config motor_drawer_1_config = {
    .hcan = &hcan2,
...
constexpr motors::DJIMotor::Config motor_drawer_2_config = {
    .hcan = &hcan2,
    .type = motors::DJIMotor::Type::M3508_C620,
    .id1 = 2,
    .reverse = false,
...
constexpr motors::DJIMotor::Config motor_drawer_3_config = {
    .hcan = &hcan2,
    .type = motors::DJIMotor::Type::M3508_C620,
    .id1 = 3,
    .reverse = false,
...
constexpr motors::DJIMotor::Config motor_drawer_4_config = {
    .hcan = &hcan2,
    .type = motors::DJIMotor::Type::M3508_C620,
    .id1 = 4,
    .reverse = false,
...
constexpr motors::DJIMotor::Config motor_drawer_out_config = {
    .hcan = &hcan2,
    .type = motors::DJIMotor::Type::M3508_C620,
    .id1 = 5,
    .reverse = false,
...
static void drawer_motor_init() {
  using namespace motors;
  motor_drawer_1 = new DJIMotor(motor_drawer_1_config);
  motor_drawer_2 = new DJIMotor(motor_drawer_2_config);
  motor_drawer_3 = new DJIMotor(motor_drawer_3_config);
  motor_drawer_4 = new DJIMotor(motor_drawer_4_config);
  motor_drawer_out = new DJIMotor(motor_drawer_out_config);
}
...
void APP_Device_Update() {
  ...
  motors::DJIMotor::SendIqCommand(
      &hcan2, motors::DJIMotor::IqSetCMDGroup::IqCMDGroup_1_4);
  motors::DJIMotor::SendIqCommand(
...
bool APP_Device_isAllConnected() {
  ...
  all_connected &= (motor_drawer_3 != nullptr) && motor_drawer_3->isConnected();
  all_connected &= (motor_drawer_4 != nullptr) && motor_drawer_4->isConnected();
  all_connected &=
      (motor_drawer_out != nullptr) && motor_drawer_out->isConnected();
